    ...
    <div className="container max-w-screen-lg mx-auto">
      <div className="flex flex-wrap justify-center gap-3">
        <button className="bg-gray-700 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
          <a href="https://github.com/anthonyeca">
            <svg
        ...
        <button className="bg-blue-600 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
          <a href="https://www.linkedin.com/in/anthonyeca/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
              fill="currentColor"
        ...
        <button className="bg-teal-400 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
          <a href="mailto:anthonyeca.dev@gmail.com">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
              fill="currentColor"
